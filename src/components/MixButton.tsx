...
function MixButtonDome({
  ...
  return (
    <g opacity={submitting ? undefined : isReady ? 1 : 0.4}>
      ...
      {/* Ready glow -- breathing halo behind the button */}
      {isReady && (
        <circle
          cx={cx}
          cy={cy}
          ...
          opacity={0.28}
        >
          <animate attributeName="opacity" values="0.28;0.4;0.28" dur="2.6s" repeatCount="indefinite" />
        </circle>
      )}
      ...
      <g style={{
        ...
        {lit && (
          <circle cx={cx} cy={cy} r={r - 6} fill="url(#mixer-halo)" opacity={0.22} />
        )}
